...
Sea64 is a cycle-accurate implementation of the famous Commodore 64 8-bit home computer realesed in 1982. This emulator is fully written in the `c2x` standard of the systems programming language `C`. 
...
- `Debuggability`: Sea64 aims to be a tool for anyone that wants to debug demos, games and software designed for this very computer. The emulator will try to offer component-dependent debugging tools and prompts that help reading the state of pins and registers of each component easier.
...
You can access my blog where I document the `Commodore 64` together with my code and my journey [here](https://cdunku.github.io/cdunku/Sea64/index.html).
