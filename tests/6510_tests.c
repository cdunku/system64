...
static int m65xx_harte_tests(m65xx_t* m, char *file) {
  json_error_t error;
...
static int load_file(m65xx_t* m, char *file, uint16_t addr) {
...
static int allsuiteasm(m65xx_t* m) {
  
  m6510_test_init(m);

  load_file(m, "./tests/6502/AllSuiteA.bin", 0x4000);
...
static int m6502_functional_test(m65xx_t* m) {
  
  m6510_test_init(m);

  load_file(m, "./tests/6502/6502_functional_test.bin", 0x0);
...
static int m6502_timing_test(m65xx_t* m) {
  
  m6510_test_init(m);

  load_file(m, "./tests/6502/timingtest-1.bin", 0x1000); 
...
static int m6502_decimal_test(m65xx_t* m) {
  
  m6510_test_init(m);

  load_file(m, "./tests/6502/6502_decimal_test.bin", 0x200);
...
static int m6502_interrupt_test(m65xx_t* m) {
  
  m6510_test_init(m);

  load_file(m, "./tests/6502/6502_interrupt_test.bin", 0xA);
